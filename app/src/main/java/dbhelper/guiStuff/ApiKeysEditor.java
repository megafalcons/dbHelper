...
/**
 * display of api key commands: add keys and see what keys you have
 * @author James Dai
 * @version 5/29/24
 */
public class ApiKeysEditor extends javax.swing.JPanel {
    ...
    /**
     * creates apikeyeditor panel
     * @param l passed into class to access it's commands
     * @param s passed into class to access it's commands
     */
    ...
    /**
     * updates the keys displayed in the display drop down
     */
